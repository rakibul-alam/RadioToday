<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        ...
        <form action="{{route('segments.update',$segment->id)}}" method="post" id="form" class="form-validate is-alter ajax-form"
                ...
                <div class="row">
                        ...
                        <div class="form-control-wrap">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="title"
                                    name="title" value="{{ $segment->title }}">
                            </div>
                        </div>
                    ...
                    <div class="input-group-prepend mb-3">
                        ...
                        <div class="modal-body">
                            <img id="currentImage" src="{{ asset('storage/segments/'.$segment->image) }}" alt="Current Image" width="100px">
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        ...
                                        <textarea
                                            ...
                                            name="details" aria-label="With textarea" required>{{$segment->details}}
                                        </textarea>
                                        @error('details')
