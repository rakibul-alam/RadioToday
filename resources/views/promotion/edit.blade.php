<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        ...
        <form action="{{route('promotions.update',$promotion->id)}}" method="post" id="form" class="form-validate is-alter ajax-form"
                    ...
                    <div class="form-group col-12">
                     ...
                     <div class="input-group-prepend mb-3">
                        ...
                        <div class="modal-body">
                            <img id="currentImage" src="{{ asset('storage/promotions/'.$promotion->image) }}" alt="Current Image" width="100px">
                            ...
                            <div class="form-control-wrap">
                                <div class="input-group">
                                    ...
                                    <textarea
                                            ...
                                            name="details" aria-label="With textarea" required>{{$promotion->details}}
                                    </textarea>
                                        @error('details')
